...
public sealed class EfOrderingInboxMessageProcessor : IInboxMessageProcessor
{
    ...
    public EfOrderingInboxMessageProcessor(
        ...
        CancellationToken cancellationToken)
    {
        ...
        var inserted = await _dbContext.Database.ExecuteSqlInterpolatedAsync(
            $"""
            INSERT INTO ordering.inbox_messages
            (
                consumer_name,
                message_id,
                message_type,
        ...
        // Any Ordering state or outbox messages staged by the handler are committed
