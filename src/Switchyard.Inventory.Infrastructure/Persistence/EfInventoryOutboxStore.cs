...
public sealed class EfInventoryOutboxStore : IOutboxStore
{
    private readonly InventoryDbContext _dbContext;

    public EfInventoryOutboxStore(InventoryDbContext dbContext)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        await _dbContext.OutboxMessages.AddAsync(
            new InventoryOutboxMessageRecord
            {
    ...
    private async Task<InventoryOutboxMessageRecord> LockMessageAsync(
        Guid messageId,
        CancellationToken cancellationToken)
    {
    ...
    private static void EnsureLease(
        InventoryOutboxMessageRecord record,
        Guid messageId,
        Guid lockToken,
